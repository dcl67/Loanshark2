...
urlpatterns = (
    ...
    url(r'^index/computers/create/$', ComputerCreate.as_view(success_url=reverse_lazy('computer_index')), name='computer_create'),
    ...
    url(r'^index/printer/create/$', printer_create.as_view(success_url=reverse_lazy('printer_index')), name='printer_create'),
    ...
    url(r'^index/projector/create/$', projector_create.as_view(success_url=reverse_lazy('projector_index')), name='projector_create'),
    ...
    url(r'^index/display/create/$', display_create.as_view(success_url=reverse_lazy('display_index')), name='display_create'),
    ...
    url(r'^index/appliance/create/$', appliance_create.as_view(success_url=reverse_lazy('appliance_index')), name='display_create'),
    ...
    url(r'^index/camera/create/$', camera_create.as_view(success_url=reverse_lazy('camera_index')), name='display_create'),
    ...
    url(r'^index/hardware/create/$', hardware_create.as_view(success_url=reverse_lazy('hardware_index')), name='display_create'),
